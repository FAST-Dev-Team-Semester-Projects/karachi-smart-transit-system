...
const GreenLineLanding = () => {
  ...
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 dark:from-emerald-700 dark:to-emerald-600",
    border: "border-emerald-200 dark:border-emerald-800",
    ring: "focus:ring-emerald-500 dark:focus:ring-emerald-400",
    lightBg: "bg-emerald-100 dark:bg-emerald-900/30",
    lightText: "text-emerald-800 dark:text-emerald-200",
    cardBorder: "",
  ...
  useEffect(() => {
    ...
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/1/routes`, {
          credentials: "include",
        });
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "Green Line BRT",
        },
      });
    } catch (e) {
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          >
            <span className={theme.accent}>Green Line</span> BRT
          </h1>
...
export default GreenLineLanding;
