...
const YellowLineLanding = () => {
  ...
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-yellow-600 to-yellow-500 hover:from-yellow-700 hover:to-yellow-600 dark:from-yellow-700 dark:to-yellow-600",
  ...
  // Fetch Green Line routes (service_id = 1)
  useEffect(() => {
    let ignore = false;
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/4/routes`, {
          credentials: "include",
        });
  ...
  useEffect(() => {
    ...
    const handleReturnTripCreated = (data) => {
      // If the server provided a trip payload, and it belongs to this route, merge into trips.
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "Yellow Line BRT",
        },
      });
    } catch (e) {
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          >
            <span className={theme.accent}>Yellow Line</span> BRT
          </h1>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {!canBook && startStopId && endStopId && (
                  <div className="p-3 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg text-sm font-medium border border-red-100 dark:border-red-800 flex items-center gap-2">
              ...
              {filteredTrips.map((t) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex justietween items-start mb-4 pl-2 gap-3">
                      <div>
        ...
        {(message || error) && (
          <div className="fixed bottom-6 right-6 max-w-md animate-fade-in z-50">
            {message && (
              <div className="bg-emerald-50 dark:bg-emerald-900/30 text-yellow-700 dark:text-yellow-300 p-4 rounded-xl shadow-2xl border border-emerald-100 dark:border-emerald-800 mb-2 flex items-center gap-3">
                <CheckCircle className="w-6 h-6" />
                {message}
              </div>
            )}
            {error && (
              <div className="bg-red-50 dark:bg-red-900/30 text-red-800 dark:text-red-200 p-4 rounded-xl shadow-2xl border border-red-100 dark:border-red-800 flex items-center gap-3">
...
export default YellowLineLanding;
