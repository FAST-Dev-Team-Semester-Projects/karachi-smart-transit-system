...
const BlueLineLanding = () => {
  ...
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 dark:from-blue-700 dark:to-blue-600",
    border: "border-blue-200 dark:border-blue-800",
    ring: "focus:ring-blue-500 dark:focus:ring-blue-400",
    lightBg: "bg-blue-100 dark:bg-blue-900/30",
    lightText: "text-blue-800 dark:text-blue-200",
    cardBorder: "",
  ...
  useEffect(() => {
    ...
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/5/routes`, {
          credentials: "include",
        });
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "Blue Line BRT",
        },
      });
    } catch (e) {
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          >
            <span className={theme.accent}>Blue Line</span> BRT
          </h1>
        ...
        {(message || error) && (
          <div className="fixed bottom-6 right-6 max-w-md animate-fade-in z-50">
            {message && (
              <div className="bg-emerald-50 dark:bg-emerald-900/30 text-blue-800 dark:text-blue-200 p-4 rounded-xl shadow-2xl border border-emerald-100 dark:border-emerald-800 mb-2 flex items-center gap-3">
...
export default BlueLineLanding;
