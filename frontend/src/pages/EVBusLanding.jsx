...
const EVBusLanding = () => {
  ...
  // Theme Configuration - EV Bus (Teal/Eco)
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 dark:from-teal-700 dark:to-teal-600",
    border: "border-teal-200 dark:border-teal-800",
    ring: "focus:ring-teal-500 dark:focus:ring-teal-400",
    lightBg: "bg-teal-100 dark:bg-teal-900/30",
    lightText: "text-teal-800 dark:text-teal-200",
  ...
  useEffect(() => {
    ...
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/8/routes`, {
          credentials: "include",
        });
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "EV Bus Service",
        },
      });
    } catch (e) {
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          >
            <span className={theme.accent}>EV Bus Service</span>
          </h1>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {!canBook && startStopId && endStopId && (
                  <div className="p-3 bg-red-50 dark:bg-red-900/20 text-teal-600 dark:text-teal-400 rounded-lg text-sm font-medium border border-red-100 dark:border-red-800 flex items-center gap-2">
        ...
        {(message || error) && (
          <div className="fixed bottom-6 right-6 max-w-md animate-fade-in z-50">
            ...
            {error && (
              <div className="bg-red-50 dark:bg-red-900/30 text-teal-800 dark:text-teal-200 p-4 rounded-xl shadow-2xl border border-red-100 dark:border-red-800 flex items-center gap-3">
