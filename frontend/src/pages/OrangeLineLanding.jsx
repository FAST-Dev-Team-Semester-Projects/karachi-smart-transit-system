...
const OrangeLineLanding = () => {
  ...
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 dark:from-orange-700 dark:to-orange-600",
    border: "border-orange-200 dark:border-orange-800",
    ring: "focus:ring-orange-500 dark:focus:ring-orange-400",
    lightBg: "bg-orange-100 dark:bg-orange-900/30",
    lightText: "text-orange-800 dark:text-orange-200",
    cardBorder: "",
  ...
  useEffect(() => {
    ...
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/2/routes`, {
          credentials: "include",
        });
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "Orange Line BRT",
        },
      });
    } catch (e) {
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          >
            <span className={theme.accent}>Orange Line</span> BRT
          </h1>
        ...
        {(message || error) && (
          <div className="fixed bottom-6 right-6 max-w-md animate-fade-in z-50">
            {message && (
              <div className="bg-emerald-50 dark:bg-emerald-900/30 text-orange-800 dark:text-orange-200 p-4 rounded-xl shadow-2xl border border-emerald-100 dark:border-emerald-800 mb-2 flex items-center gap-3">
...
export default OrangeLineLanding;
