...
const RedLineLanding = () => {
  ...
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 dark:from-red-700 dark:to-red-600",
  ...
  useEffect(() => {
    ...
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/3/routes`, {
          credentials: "include",
        });
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "Red Line BRT",
        },
      });
    } catch (e) {
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            >
              <span className={theme.accent}>Red Line</span> BRT
            </h1>
            <LiveClock className="text-sm text-slate-600 dark:text-slate-400" />
          </div>
        ...
        {(message || error) && (
          <div className="fixed bottom-6 right-6 max-w-md animate-fade-in z-50">
            {message && (
              <div className="bg-emerald-50 dark:bg-emerald-900/30 text-red-800 dark:text-red-200 p-4 rounded-xl shadow-2xl border border-emerald-100 dark:border-emerald-800 mb-2 flex items-center gap-3">
