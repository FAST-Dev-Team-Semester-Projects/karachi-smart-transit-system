...
const BrownLineLanding = () => {
  ...
  const theme = {
    ...
    buttonGradient:
      "bg-linear-to-r from-amber-600 to-amber-500 hover:from-amber-700 hover:to-amber-600 dark:from-amber-700 dark:to-amber-600",
    border: "border-amber-200 dark:border-amber-800",
    ring: "focus:ring-amber-500 dark:focus:ring-amber-400",
    lightBg: "bg-amber-100 dark:bg-amber-900/30",
    lightText: "text-amber-800 dark:text-amber-200",
    cardBorder: "",
  ...
  useEffect(() => {
    ...
    const fetchRoutes = async () => {
      ...
      setError("");
      try {
        const res = await fetch(`${API_BASE}/api/services/6/routes`, {
          credentials: "include",
        });
    ...
    try {
      ...
      navigate("/payment", {
        state: {
          ...
          service_name: fareData.service_name || "Brown Line BRT",
        },
      });
    } catch (e) {
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div className="relative flex items-center justify-center mb-8">
          ...
          >
            <span className={theme.accent}>Brown Line</span> BRT
          </h1>
        ...
        {(message || error) && (
          <div className="fixed bottom-6 right-6 max-w-md animate-fade-in z-50">
            {message && (
              <div className="bg-emerald-50 dark:bg-emerald-900/30 text-amber-800 dark:text-amber-200 p-4 rounded-xl shadow-2xl border border-emerald-100 dark:border-emerald-800 mb-2 flex items-center gap-3">
...
export default BrownLineLanding;
